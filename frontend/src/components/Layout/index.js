      ...
      <Layout>
        ...
        <Layout>
          <Sider width={200} style={{ background: '#fff' }}>
            ...
            >
              <SubMenu key="sub1" title={<span><Icon type="dashboard" />Dashboard</span>}>
                <Menu.Item key="1">
                  <Link to="/dashboard">Dashboard</Link>
                </Menu.Item>
              </SubMenu>
              <SubMenu key="sub2" title={<span><Icon type="copy" />Pages</span>}>
                <Menu.Item key="2">
              ...
              <SubMenu key="sub4" title={<span><Icon type="notification" />Article / News</span>}>
